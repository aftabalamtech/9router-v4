...
export const FREE_PROVIDERS = {
  ...
  opencode: { id: "opencode", alias: "oc", name: "OpenCode Free", icon: "terminal", color: "#E87040", textIcon: "OC", noAuth: true, passthroughModels: true, modelsFetcher: { url: "https://opencode.ai/zen/v1/models", type: "opencode-free" }, notice: { text: "Anonymous use is currently blocked upstream (FreeTierError). Add a free API key to use the $0 models.", apiKeyUrl: "https://opencode.ai/auth" } },
};
...
export const OAUTH_PROVIDERS = {
  ...
  antigravity: { id: "antigravity", alias: "ag", name: "Antigravity", format: "gemini", icon: "rocket_launch", color: "#F59E0B", deprecated: true, deprecationNotice: "⚠️ Antigravity rides on the IDE's OAuth session (standard tier), which Google does not officially license for router/proxy use — Google also enforces per-account eligibility (a 'Verify your account' gate); when that triggers, every model fails with 403 VALIDATION_REQUIRED until you verify the account in a browser. A proxy will not bypass this. For officially supported Gemini access on this router use the Vertex AI provider (service account) — or Gemini with an AI Studio API key.", website: "https://antigravity.google", notice: { signupUrl: "https://antigravity.google" } },
